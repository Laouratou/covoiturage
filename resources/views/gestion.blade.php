            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
                        <div class="p-6">
                            <h2 class="text-xl font-semibold">{{ $trajet->ville_de_depart }} - {{ $trajet->ville_d_arrivee }}</h2>
                            <p class="text-gray-500 mt-2">Publié par : {{ $trajet->user->name }}</p>
                        </div>
                        <div class="bg-gray-100 px-4 py-3 flex justify-between items-center">
                            <a href="{{ route('trajets.edit', $trajet->id) }}" class="text-blue-500 hover:underline">Modifier</a>
