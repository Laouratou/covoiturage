...
<body>
    ...
    <h2 class="text-5xl text-center font-bold py-16">Choisissez le type de compte</h2>
    <div class="flex justify-center items-center">
        <div class="max-w-md mr-4">
            <div class="border border-gray-300 rounded-lg overflow-hidden hover:scale-105 transform transition duration-300">
                <div class="border border-gray-300 rounded-lg overflow-hidden hover:rotate-12 transform transition duration-500">
                    <img src="img/conduc.jpeg" alt="Image de la carte" class="object-cover w-full h-64">
                </div>
                <div class="p-4">
                    <h2 class="text-2xl font-bold mb-2">Conducteurs</h2>
                    <p class="text-gray-800 text-sm">Faites partie d'une communauté de conducteurs engagés et rencontrez de nouvelles personnes tout en économisant sur vos frais de carburant. Inscrivez-vous sur notre plateforme de covoiturage aujourd'hui. La communauté est le cœur du covoiturage, où les rencontres deviennent des amitiés.</p>
                    <a href="register2" class="text-blue-500 font-medium" id="bouton"><i class="fas fa-plus-circle text-blue-500 py-3"></i>Créer un compte conducteur</a>
                </div>
            </div>
        </div>
        <div class="max-w-md mr-8">
            <div class="border border-gray-300 rounded-lg overflow-hidden hover:scale-105 transform transition duration-300">
                <div class="border border-gray-300 rounded-lg overflow-hidden hover:rotate-12 transform transition duration-500">
                    <img src="img/city.jpg" alt="Image de la carte" class="object-cover w-full h-64">
                </div>
                <div class="p-4">
                    <h2 class="text-2xl font-bold mb-2">Passagers</h2>
                    <p class="text-gray-800 text-sm">Envie de voyager de manière économique, conviviale et écologique ? Rejoignez notre communauté de covoiturage dès maintenant ! Profitez de trajets confortables, de rencontres enrichissantes et de partage d'expériences. Inscrivez-vous en quelques clics et embarquez dans l'aventure du covoiturage avec nous</p>
                    <a href="register" class="text-blue-500 font-medium opacity-1 transition-opacity duration-300" id="bouton"><i class="fas fa-plus-circle text-blue-500 py-3"></i>Créer un compte passager</a>
                </div>
            </div>
        </div>
    </div>
