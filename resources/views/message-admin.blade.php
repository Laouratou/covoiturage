      ...
      <a href="/gestion" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
        ...
        <div class="flex justify-center items-center h-screen bg-gray-100">
            <div class="w-full md:w-1/2 bg-white rounded-lg shadow-lg p-6">
                <h1 class="text-2xl font-semibold mb-4">Envoyer un message</h1>
                <form action="{{ route('messages.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="receiver_id" class="block font-semibold mb-2">Destinataire :</label>
                    ...
                    <div class="mb-4">
                        <label for="content" class="block font-semibold mb-2">Contenu :</label>
